...
class GRUNet(nn.Module):
    def __init__(self, input_size, predict_times_step=1):
        ...
        if predict_times_step == 1:
            ...
            self.out = nn.Conv1d(128, 1, 1) # output future_time = time_step
    ...
    def forward(self, x):
        ...
        if self.predict_times_step == 1:
            ...
            out = self.out(r_out).squeeze(dim=-2)[:,:self.predict_times_step]
        return out
